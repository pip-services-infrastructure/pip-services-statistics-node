...
class StatisticsServiceFactory extends pip_services_commons_node_1.Factory {
    constructor() {
        super();
...
StatisticsServiceFactory.Descriptor = new pip_services_commons_node_2.Descriptor("pip-services-statistics", "factory", "default", "default", "1.0");
StatisticsServiceFactory.MemoryPersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-statistics", "persistence", "memory", "*", "1.0");
StatisticsServiceFactory.FilePersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-statistics", "persistence", "file", "*", "1.0");
StatisticsServiceFactory.MongoDbPersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-statistics", "persistence", "mongodb", "*", "1.0");
StatisticsServiceFactory.ControllerDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-statistics", "controller", "default", "*", "1.0");
StatisticsServiceFactory.SenecaServiceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-statistics", "service", "seneca", "*", "1.0");
StatisticsServiceFactory.HttpServiceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-statistics", "service", "http", "*", "1.0");
