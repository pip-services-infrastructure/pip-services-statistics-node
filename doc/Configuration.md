# Configuration Guide <br/> Statistics Microservice

Statistics microservice configuration structure follows the 
...
Example:
```yaml
- descriptor: "pip-services-statistics:persistence:memory:default:1.0"
  options:
    max_page_size: 100
```
...
Example:
```yaml
- descriptor: "pip-services-statistics:service:seneca:default:1.0"
  connection:
    protocol: "http"
    host: "0.0.0.0"
    port: 3000
